...
function getCarHonda (cars) {
    ...
    const sentance = `this is a ${firstHonda.car_make }, ${firstHonda.car_model} os ${firstHonda.car_year}`
}
...
function sortCarInventoryByYear () {
    const sortedCaars = cars.sort((a, b) => (a.car_year < b.car_year  ? -1 : 1))
}
